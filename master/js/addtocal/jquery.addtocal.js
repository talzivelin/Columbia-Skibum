    ...
    options: {
      ...
      calendars : [
        {value: 1,
          ...
          enabled : function(addtocal) { return addtocal.options.googleEnabled; },
        ...
        {value: 2, label:"Add to Live Calendar",
          enabled : function(addtocal) { return addtocal.options.liveEnabled; },
          formatlink : function(eventDetails) {
        ...
        {value: 3, label:"Add to Yahoo! Calendar",
          enabled : function(addtocal) { return addtocal.options.yahooEnabled; },
          formatlink : function(eventDetails) {
